...
import { findAllReturnededBooks } from '../fn/book/find-all-returneded-books';
import { FindAllReturnededBooks$Params } from '../fn/book/find-all-returneded-books';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllReturnededBooks()` */
  static readonly FindAllReturnededBooksPath = '/books/returned';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllReturnededBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturnededBooks$Response(params?: FindAllReturnededBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllReturnededBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllReturnededBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturnededBooks(params?: FindAllReturnededBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllReturnededBooks$Response(params, context).pipe(
